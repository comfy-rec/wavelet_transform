...
BEGIN_MESSAGE_MAP(CWaveletTransformDoc, CDocument)
	ON_COMMAND(ID_WAVELET_TRANSFORM, &CWaveletTransformDoc::OnWaveletTransform)
END_MESSAGE_MAP()
...
void CWaveletTransformDoc::OnWaveletEncode()
{
	...
	double* m_Conv1 = NULL, * m_Conv2 = NULL, * m_Conv3 = NULL, * m_Conv4 = NULL;
	// Convolution을 위한 버퍼
	double* m_Down1 = NULL, * m_Down2 = NULL, * m_Down3 = NULL, * m_Down4 = NULL;
	// 다운 샘플링을 위한 버퍼
	double* m_Hor = NULL, * m_Ver1 = NULL, * m_Ver2 = NULL;
	double** m_L = NULL, ** m_H = NULL, ** m_LL = NULL, ** m_LH = NULL, ** m_HL = NULL;
	double** m_HH = NULL, ** m_SLL = NULL, ** m_SLH = NULL, ** m_SHL = NULL, ** m_SHH = NULL;
	...
	void CWaveletTransformDoc::OnWaveletDecode()
	{
		...
		int i, j, k;
		int width, height;
		double* tempLL = NULL, * tempLH = NULL, * tempHL = NULL, * tempHH = NULL, * tempL = NULL, * tempH = NULL;
		double** L = NULL, ** H = NULL;
		double* Up1 = NULL, * Up2, * Up3, * Up4;
		double* Conv1 = NULL, * Conv2, * Conv3, * Conv4;
		double** R = NULL;
